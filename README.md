...
lastmod: 2026-01-02T00:00:00+09:00   # 任意。記事を更新したときに記載
tags: ["Resonite", "作ったもの"]
description: "一覧・検索結果・OGP に表示される1〜2文の説明。"
thumbnail: "thumbnail.webp"          # 任意。同フォルダに置いたサムネイル画像
emoji: "⚡"                           # 任意。thumbnail がないときのカバー絵文字(未指定は📝)
series: "シリーズ名"                  # 任意。同じ値の記事を日付順に前後ナビで自動連結
pickup: true                         # 任意。トップページのピックアップ枠に掲載
externalUrl: "https://…"             # 任意。一覧カードのリンク先を外部サイトにする(公開ツール記事用)
draft: false                         # true の間は本番に公開されない
---
```
