...
この記事は [Resonite Advent Calendar 2025](https://adventar.org/calendars/12050) の4日目の記事です

https://adventar.org/calendars/12050
...
https://uni-pocket.com/ja/items/cd78af9f-3f05-4da8-b499-a477111c2f8f

また、Resoniteで作業する際はこまめにインベントリにバックアップを保存するようにしましょう。

以下のサイトも参考になるので、ぜひ目を通してみてください。

https://wikiwiki.jp/resonaito/%E9%80%B8%E8%88%AC%E4%BA%BA%E5%90%91%E3%81%91%E3%82%A2%E3%83%90%E3%82%BF%E3%83%BC%E3%82%BB%E3%83%83%E3%83%88%E3%82%A2%E3%83%83%E3%83%97

https://wikiwiki.jp/resonaito/%E3%82%A2%E3%83%90%E3%82%BF%E3%83%BC%E6%9C%80%E9%81%A9%E5%8C%96Tips
...
日本の[ResoniteDiscordサーバー](https://discord.gg/resonite-japan)で「アバター設定依頼」をしてみてください。

どうしても一人でやりたい方は、Resoniteの操作をある程度覚えてから、以下のサイトなどを参考にしてみてください。(最近はモジュラーアバター使っている人が多いかも)

https://note.com/your0409/n/ndc08db097ee5

https://dinosaur-fossil.hatenablog.com/entry/2024/09/11/215603

https://berne.fanbox.cc/posts/11215400
...
![椅子に座ると浮いている状態](<2025-11-24 17.17.42.webp>)

hipsとspineの距離を元にhipsコライダーを生成するため、足元から胸あたりまである巨大コライダーが生成され、デスクトップモードで手が浮いてしまいます。
![巨大コライダーで手が浮いている状態](<2025-11-26 19.51.29.webp>)
...
![NoIKタグの設定例](rapture_20251126191101.jpg)
...
### Resoniteが推奨する構造
![Resoniteが推奨するボーン構造](<https://media.wiki.resonite.com/5/53/IK_Rig_Bones.png>)
...
![スケールが不均一な例](<2025-11-24 17.28.00.webp>)
...
![Blenderでのスケール適用](rapture_20251126180724.jpg)
...
![glbエクスポート設定](rapture_20251205192120.jpg)
...
![ブレンドシェイプの法線除去](<2025-12-05 19.24.58.webp>)
...
![fbxエクスポート設定](rapture_20251126181444.jpg)
...
![動かしてもよいスロット](<2025-11-27 17.51.41.webp>)
...
![アバタークリエイターの揃える系ボタン](<2025-11-24 17.34.19.webp>)
...
![ツールの位置](<2025-11-24 17.31.51.webp>)

## 椅子で腰がひっくり返る

hipsボーンとspineボーンが十分離れていないと、椅子に座った際に少し頭を下げるだけで腰がひっくり返ります。
![腰がひっくり返っている状態](<2025-11-24 17.16.11.webp>)

Blender等でhipsをspineから離しましょう。

**元の位置**：ほぼ重なっている状態
![元の位置](rapture_20251126180359.jpg)

**修正後**：Blenderの編集モードでhipsボーンを少し下げます
![修正後](rapture_20251126180459.jpg)

これで、きれいに座れるようになります。
![きれいに座れる状態](<2025-11-24 17.20.55.webp>)

## 首が伸びる

何も設定していないとよく首が伸びてしまいます（伸びて見えるのは自分からだけかもしれません）。

![首が伸びている状態](<2025-11-24 17.19.15.webp>)
...
![HeadMaxFixDistanceの設定](<2025-11-26 17.19.45.webp>)

## 足の接地
![足が地面にめり込んでいない状態](<2025-11-24 18.03.17.webp>)
...
![FootHeightの設定](<2025-11-24 18.04.40.webp>)
...
![指を貫通させないと押せない状態](<2025-11-24 17.50.24.webp>)
...
![TipTouchSourceの移動](<2025-11-24 17.47.19.webp>)

これで指先でボタンが押せるようになります。
![指先でボタンが押せる状態](<2025-11-24 17.49.47.webp>)
...
![Tool Anchorのスケール調整](<2025-11-24 17.44.40.webp>)

調整すると、ちゃんと真横に出るようになります。
![レーザーのヒゲが真横に出ている状態](<2025-11-24 17.43.23.webp>)
...
https://wikiwiki.jp/resonaito/%E9%80%B8%E8%88%AC%E4%BA%BA%E5%90%91%E3%81%91%E3%82%A2%E3%83%90%E3%82%BF%E3%83%BC%E3%82%BB%E3%83%83%E3%83%88%E3%82%A2%E3%83%83%E3%83%97#hd62314d

**調整前**：腰コライダーが小さかったり、手のコライダーが傾いていたりします。外側のコライダーも少し大きすぎます。
![コライダー調整前](<2025-11-24 17.25.46.webp>)

**調整後**：いい感じです。
![コライダー調整後](<2025-11-24 17.24.37.webp>)

## スカート貫通
Resoniteで貫通対策を完璧に行うのは大変なので、比較的簡単にできる方法を紹介します。

しゃがんだ時に、スカートが足に当たって持ち上がってしまう現象です。
![スカートが持ち上がっている状態](<2025-11-24 17.52.47.webp>)

これは、大きなボーンコライダーを足につけることで対策しています。
![足のボーンコライダー](<2025-11-24 17.53.51.webp>)

また、横のスカートが足より内側に来ないように、このようなコライダーもつけています。
![スカート貫通対策のコライダー](<2025-11-24 17.57.22.webp>)

## ボーンを掴んだり伸ばしたりできるように

アホ毛を引っ張ったり、スカートをめくったりしたいですよね。
![ボーンを掴んでいる状態](<2025-11-24 17.59.36.webp>)
...
![DynamicBoneChainの設定](<2025-11-24 18.00.47.webp>)
...
![EyeLinearDriverの設定](<2025-12-03 19.02.36.webp>)
...
![ブレンドシェイプの分割](<スクリーンショット 2025-12-03 190958.webp>)
...
![AvatarMouthDataSourceAssignerの設定](<2025-12-02 21.47.23.webp>)

![DirectVisemeDriverの設定](<2025-12-02 21.47.32.webp>)
...
https://go.resonite.com/world/U-1ab6590e-9cac-43c3-a23f-147579e0f277/R-72f1c4dc-33be-4565-9635-ada5785df81b
...
https://wikiwiki.jp/resonaito/Rendering/LODGroup
...
![BoundsComputeMethodの設定](<2025-12-03 18.47.05.webp>)
...
**コンポーネント 283 FPS**
![コンポーネントのFPS測定結果](<2025-12-04 17.57.46.webp>)

**Flux 14 FPS**
![FluxのFPS測定結果](<2025-12-04 17.59.09.webp>)

圧倒的な差があります。比較に使用した実装は以下の通りです。

**コンポーネント** （`AvatarRawToolData`から`ValueFeald`に`ValueCopy`）
![コンポーネントの実装](<2025-11-26 23.14.55.webp>)

**Flux** （Fluxで`ValueFeald`にドライブ）
![Fluxの実装](<2025-11-26 23.07.43.webp>)
...
![AvatarRawToolDataの設定](<2025-11-26 17.23.13.webp>)
...
![表情制御の実装](<2025-11-26 17.24.20.webp>)
...
![テクスチャの解像度調整](<2025-11-26 16.38.41.webp>)
...
![アルファを取り除くボタン](<2025-11-26 16.37.56.webp>)

**効果**:
*   アルファ除去前: 21.33MB（圧縮形式がBC3）
    ![アルファ除去前のテクスチャ](<2025-11-26 16.38.16.webp>)
...
![最適化前のFPS測定結果2](<2025-12-06 16.49.14.webp>)
![最適化前のFPS測定結果3](<2025-12-06 16.49.46.webp>)
![最適化前のFPS測定結果4](<2025-12-06 17.29.28.webp>)

### 最適化後スクショ

![最適化後のFPS測定結果1](<2025-12-06 16.51.13.webp>)
![最適化後のFPS測定結果2](<2025-12-06 16.51.45.webp>)
![最適化後のFPS測定結果3](<2025-12-06 16.52.17.webp>)
![最適化後のFPS測定結果4](<2025-12-06 17.24.15.webp>)
