...
{{< figure src="スクリーンショット 2026-06-08 221716.png" title="「「ユーザー」タブ" alt="ユーザー名／ユーザーIDでの検索 → フレンド申請・解除、フォーカス中セッションへの招待、メッセージ送信" class="figure-unindented-center" >}}
...
{{< figure src="スクリーンショット 2026-06-08 222159.png" title="「新規セッション」タブ" alt="テンプレートやURL、ワールド検索から新しいセッションを開く新規セッションタブのスクリーンショット" class="figure-unindented-center" >}}
...
{{< figure src="スクリーンショット 2026-06-08 222441.png" title="「コンフィグ」タブ" alt="GUIでヘッドレスのコンフィグを作成・編集するコンフィグタブのスクリーンショット" class="figure-unindented-center" >}}
...
{{< figure src="スクリーンショット 2026-06-08 222504.png" title="「スケジュール」タブ：稼働状態" alt="稼働時間やCPU・メモリ・ディスク使用率を表示するスケジュールタブの状態表示のスクリーンショット" class="figure-unindented-center" >}}
...
{{< figure src="スクリーンショット 2026-06-08 222504-1.png" title="「設定」タブ" alt="管理パスワード・Resoniteアカウント・Steam設定・キャッシュ管理を行う設定タブのスクリーンショット" class="figure-unindented-center" >}}
